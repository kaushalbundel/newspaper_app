...
SECRET_KEY = "django-insecure-z(ujy)vu6!8rr4w(cph#=h81tth_pq-np45cq67rfiupgjeiyw"
...
AUTH_USER_MODEL = "users.CustomUser"  # This is to communicate to Django that we are using a custom model instead of the built-in model
